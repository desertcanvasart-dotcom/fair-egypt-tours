...
export const destinations: Destination[] = [
  /* ============================ CAIRO & GIZA ============================ */
  {
    ...
    gallery: [
      ...
      "/img/real/giza-three-pyramids-group.jpg",
      "/img/real/giza-group-white-pyramid.jpg",
      "/img/real/giza-sphinx-group-friends.jpg",
    ],
  ...
  /* ================================ LUXOR ================================ */
  {
    ...
    gallery: [
      ...
      "/img/real/karnak-hypostyle-group.jpg",
      "/img/real/karnak-obelisks-group.jpg",
      "/img/real/karnak-pylon-group.jpg",
      "/img/real/karnak-ram-sphinxes.jpg",
      "/img/real/karnak-sphinx-avenue-couple.jpg",
      "/img/real/luxor-temple-colossi-1.jpg",
      "/img/real/luxor-temple-colossi-2.jpg",
      "/img/real/luxor-temple-reliefs.jpg",
    ],
  ...
  /* ================================ ASWAN ================================ */
  {
    ...
    gallery: [
      ...
      "/img/real/aswan-camel-ride.jpg",
      "/img/real/aswan-philae-coptic-altar.jpg",
    ],
  ...
  /* ============================== ALEXANDRIA ============================== */
  {
    ...
    gallery: [
      ...
      "/img/real/alexandria-qaitbay-citadel-group.jpg",
    ],
  ...
  /* ================================= SIWA ================================= */
  {
    ...
    gallery: [
      ...
      "/img/real/siwa-oasis-overlook.jpg",
    ],
    tourSlugs: [],
  },
];
